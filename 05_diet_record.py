...
with st.sidebar:
    ...
    # === 変更点①＆③：AIで上限を推定（早期減量プラン）→ まず表示、保存ボタンで反映 ===
...
"""
            ...
            try:
                ...
                resp = client.chat.completions.create(
                    model=ai_model, messages=[{"role": "system", "content": system_msg},{"role": "user", "content": user_msg}], temperature=0.6,
                )
